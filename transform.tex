...
case of this transformation. %which extends immediately to the more general results, as discussed
...
in \prettyref{lem:FtoAbasis}. However, it requires more work to extract
